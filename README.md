...
├── 6-sample-logs/
│   ├── activity.log                       # Sample execution log - Generated by AppleScript
│   └── last-export.txt                    # Sample last export date - Generated by AppleScript
├── .gitignore                           
├── LICENSE                              
...
└── last-export.txt                   # Tracks last export date to prevent duplicates

~/Library/Logs/jun-bill-dashboard/
└── activity.log                      # Execution log (rotated to keep last 150 entries)

~/Library/Mobile Documents/com~apple~ScriptEditor2/Documents/jun-bill-dashboard/
├── export.scpt                       # Main export script (iCloud synced)
└── log-rotate.scpt                   # Log rotation script (iCloud synced)
```
